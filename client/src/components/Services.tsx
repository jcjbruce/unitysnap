 ...
 * Clean card grid matching the Sectors pattern.
 * Icon + title + description. No images, no tags.
...
const services = [
  ...
  },
  {
    ...
    desc: "We sharpen your message before a single pixel is placed — developing the voice, visual language, and content architecture that makes your mission clear.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.384 3.161 1.439-5.97-4.725-3.89 6.13-.404L12 2.586l3.12 5.481 6.13.404-4.725 3.89 1.44 5.97-5.385-3.161z" />
      </svg>
    ),
  ...
  return (
    <section id="services" className="py-20 md:py-28 bg-background">
      <div className="container">
        ...
        {/* Services card grid — matches Sectors pattern */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((service, i) => (
            ...
            >
              ...
              <h3 className="font-semibold text-sm md:text-base text-foreground mb-2 leading-tight">
                {service.title}
              </h3>
